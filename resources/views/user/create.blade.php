            ...
            <div class="card-body">
              ...
              <form class="" action="{{ route('user.store') }}" onsubmit="return(validateForm());" method="POST">
                ...
                <div class="form-group">
                  ...
                  <input type="date" class="form-control" name="dateBirthday" id="dateBirthday" required placeholder="Nhập ngày sinh" />
                </div>
                <div class="form-group">
                  <label>Địa chỉ</label>
                ...
                <div class="form-group">
                  <label>E-Mail</label>
                  <div>
                    <input type="email" class="form-control" required name="txtEmail" id="txtEmail" parsley-type="email" placeholder="Nhập địa chỉ email" />
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    <div>
                      <button type="submit" class="btn btn-primary waves-effect waves-light" style="margin-top: 15px;">Thêm mới</button>
                      <button type="reset" class="btn btn-secondary waves-effect m-l-5" style="margin-top: 15px;">
                        Xóa thông tin
                      </button>
                    </div>
                  </div>
