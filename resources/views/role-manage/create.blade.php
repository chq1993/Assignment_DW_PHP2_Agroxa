        ...
        <div class="col-lg-12">
            <div class="card m-b-20">
                <div class="card-body">
                    ...
                    <p class="text-muted m-b-30 ">Vui lòng nhập đầy đủ thông tin để có thể tạo mới vai trò cho người
                        dùng!</p>
                    ...
                    <form name="myForm" action="{{ route('role-manage.store') }}" onsubmit="return validateForm()"
                        method="POST">
                        @csrf
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="date" class="form-control" name="dateStartTime" id="dateStartTime" required
                                    placeholder="Nhập ngày bắt đầu làm vai trò này" />
                            </div>
                            <div class="form-group col-md-4">
