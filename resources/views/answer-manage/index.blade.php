            ...
            <div class="card m-b-20">
                <div class="card-body">
                    ...
                    <section class="d-flex justify-content-between">
                        ...
                        <a href="{{ route('answer-manage.create') }}" style="margin: 19px;"
                            ...
                            <table id="tech-companies-1" class="table table-bordered table-striped">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                ...
                                                <div class="dropdown">
                                                    <button type="button" class="btn btn-sm shadow-none bg-transparent"
                                                        id="dapAn" data-toggle="dropdown" aria-haspopup="true"
                                                        ...
                                                        <div class="p-2">
                                                            ...
                                                            <form role="search-answer" class="table-search rounded">
                                                                <div class="form-group mb-0">
                                                                    ...
                                                                    --}}
                                                                    <select class="form-control" name="search-answer"
                                                                        id="search-answer">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <a href="/answer-manage" type="reset"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$answer->value_answer}} điểm</td>
                                        <td>
                                            <div class="d-flex">
                                                ...
                                                <form action="{{ route('answer-manage.destroy', $answer->id) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button onclick="return confirm('Bạn có chắc muốn xóa?')"
                                                        class="btn btn-outline-danger waves-effect waves-light" type="submit"><i
