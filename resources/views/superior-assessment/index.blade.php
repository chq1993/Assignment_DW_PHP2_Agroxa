        ...
        <div class="col-12">
            ...
            <div class="card m-b-20">
                <div class="card-body">
                    ...
                    <h5>
                        <span> Bảng danh sách đánh giá cấp trên</span>
                            ...
                            <table id="tech-companies-1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <a href="{{ route('superior-assessment.show', ['superior_assessment' => $item->id]) }}"
                                                    class="btn btn-outline-primary waves-effect waves-light mr-2"><i
                                                        class="far fa-edit"></i></a>
                                                <form action="{{ route('superior-assessment.destroy', $item->id) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
