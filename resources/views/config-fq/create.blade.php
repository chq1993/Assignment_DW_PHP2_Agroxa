            ...
            <div class="form-row w-100">
                ...
                <div class="list-group m-b-30">
                  ...
                  <li class="list-group-item">
                    <div class="form-check">
                      ...
                      <label class="form-check-label" for="{{$key}}">{{$question->question}}</label>
                    </div>
                  </li>
                  @endforeach
              ...
              <div class="form-group col-md-4" id="test">
                ...
                <div style="position: sticky; top: 0" class="list-group m-b-30">
                  ...
                  <li class="list-group-item">
                    <div class="form-check">
                      @if ( $configForm->id == $form->id )
                      <input type="radio" name="chooseForm" value="{{$form->id}}"
                        class="form-check-input radioCheckForm" id="{{$key}}"
                        checked="{{ $configForm->id == $form->id }}">
                      @else
                      <input type="radio" name="chooseForm" value="{{$form->id}}"
                        class="form-check-input radioCheckForm" id="{{$key}}">
                      @endif
                  ...
                  @endforeach
                  <button style="z-index: 2" type="submit" class="btn btn-outline-primary waves-effect waves-light">
                    Lưu
                  </button>
                </div>
              </div>
...
<script type="text/javascript">
  $(document).ready(function(){
        ...
        console.log('id loại phiếu: ',rCheckForm[0].checked, question);
