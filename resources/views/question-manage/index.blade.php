                    ...
                    <section class="d-flex justify-content-between">
                        <form role="table-search" class="table-search rounded w-25 py-3">
                            <div class="form-group mb-0">
                                <input name="search-question" type="text" class="form-control" placeholder="Tìm kiếm...">
                            </div>
                        </form>
                        <a href="{{ route('question-manage.create') }}" style="margin: 19px;"
                            class="btn btn-primary waves-effect waves-light mx-0">
                                    ...
                                    <tr style="background-color: #35a989" class="shadow-sm text-white">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                ...
                                                <div class="dropdown">
                                                    <button type="button" class="btn btn-sm shadow-none bg-transparent"
                                                        id="isearch-question" data-toggle="dropdown"
                                                    ...
                                                    <div class="dropdown-menu shadow"
                                                        aria-labelledby="isearch-question">
                                                        <div class="p-2">
                                                            ...
                                                            <form role="search-question" class="table-search rounded">
                                                                <div class="form-group mb-0">
                                                                    ...
                                                                    --}}
                                                                    <input style="height: 34px" id="search-question"
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-between align-items-center">
                                                ...
                                                <div class="dropdown">
                                                    <button type="button" class="btn btn-sm shadow-none bg-transparent"
                                                        id="isearch-group-question" data-toggle="dropdown"
                                                        aria-haspopup="true" aria-expanded="false"
                                                        data-offset="-130,15">
                                                    ...
                                                    <div class="dropdown-menu shadow"
                                                        aria-labelledby="isearch-group-question">
                                                        <div style="width: 174px" class="p-2">
                                                            <form role="search-group-question"
                                                                class="table-search rounded">
                                                                <div class="form-group mb-0">
                                                                    <select class="form-control"
                                                                        name="search-group-question"
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-between align-items-center">
                                                ...
                                                <div class="dropdown">
                                                    <button type="button" class="btn btn-sm shadow-none bg-transparent"
                                                        id="isearch-type-question" data-toggle="dropdown"
                                                        aria-haspopup="true" aria-expanded="false"
                                                        data-offset="-120,15">
                                                        <i class="fas fa-filter text-white"></i>
                                                    </button>
                                                    ...
                                                    <div class="dropdown-menu shadow"
                                                        aria-labelledby="isearch-type-question">
                                                        <div class="p-2">
                                                            <form role="search-type-question"
                                                                class="table-search rounded">
                                                                <div class="form-group form-check">
                                                                    <input type="checkbox" class="form-check-input"
                                                                        value="0" name="text-question-type"
                                                                ...
                                                                <div class="form-group form-check">
                                                                    <input type="checkbox" class="form-check-input"
                                                                        value="1" name="select-question-type"
                                                                        id="select-question-type">
                                                                    <label class="form-check-label font-weight-normal"
                                                                        for="select-question-type">Lựa
                                                                        chọn</label>
                                                                </div>
                                                                <hr>
                                                                <div
                                                                    class="mt-2 w-100 d-flex justify-content-between align-items-center">

                                                                    <button type="reset"
                                                                        class="btn btn-sm shadow-sm btn-hover w-50 mr-1">xóa</button>
                                                                    <button type="submit"
                                                                        class="btn btn-sm btn-primary shadow-sm w-50 ml-1">
                                                                        <span>Lọc</span>
                                                                    </button>
                                                                </div>
                                                            </form>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-between align-items-center">
                                                ...
                                                <div class="dropdown">
                                                    <button type="button" class="btn btn-sm shadow-none bg-transparent"
                                                        id="isearch-required-question" data-toggle="dropdown"
                                                        aria-haspopup="true" aria-expanded="false"
                                                        data-offset="-120,15">
                                                        <i class="fas fa-filter text-white"></i>
                                                    </button>
                                                    ...
                                                    <div class="dropdown-menu shadow"
                                                        aria-labelledby="isearch-required-question">
                                                        <div class="p-2">
                                                            <form role="search-required-question"
                                                                class="table-search rounded">
                                                                <div class="form-group form-check">
                                                                    <input type="checkbox" class="form-check-input"
                                                                        value="1" name="required-question"
                                                                        id="required-question">
                                                                    <label class="form-check-label font-weight-normal"
                                                                        for="required-question">Bắt
                                                                        buộc</label>
                                                                </div>
                                                                <div class="form-group form-check">
                                                                    <input type="checkbox" class="form-check-input"
                                                                        value="0" name="not-required-question"
                                                                        id="not-required-question">
                                                                    <label class="form-check-label font-weight-normal"
                                                                        for="not-required-question">Không
                                                                        bắt buộc</label>
                                                                </div>
                                                                <hr>
                                                                <div
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                ...
                                                <a href="{{ route('config-aq.create', ['config_aq' => $question->id]) }}"
                                                    class="btn btn-outline-success waves-effect waves-light ml-2"><i
                                                        class="fas fa-cogs"></i></a>
                                                <form action="{{ route('question-manage.destroy', $question->id) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
